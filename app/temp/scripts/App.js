...
var MobileMenu = function () {
    ...
    _createClass(MobileMenu, [{
        ...
        value: function events() {
            this.menuIcon.click(this.toggleTheMenu.bind(this)); //anything in bind(), will be bind to the calling this
        }
    }, {
        key: "toggleTheMenu",
            ...
            this.itemsToReveal.each(function () {
                ...
                new Waypoint({
                    ...
                    handler: function handler() {
                        ...
                        (0, _jquery2.default)(currentItem).addClass("reveal-item--no-offset");
                    },
                    offset: that.offset
                });
            });
...
var StickyHeader = function () {
    function StickyHeader() {
        ...
        this.siteHeader = (0, _jquery2.default)(".site-header");
        this.headerTriggerElem = (0, _jquery2.default)(".large-hero__title");
        this.createHeaderWaypoint();
        this.pageSections = (0, _jquery2.default)(".page-section"); //gets every page section
        this.headerLinks = (0, _jquery2.default)(".primary-nav a"); //gets all link in nav bar
                ...
                new Waypoint({
                    ...
                    handler: function handler(direction) {
                        if (direction == "down") {
                            ...
                            (0, _jquery2.default)(matchingHeaderLink).addClass("is-current-link"); //apply highlight to scrolled area corresponding link
                        }
                    },
                    offset: "22%"
                });
